...
```
python3 .\simple_extractor.py --dataset pascal --model-restore pretrain_model\exp-schp-201908270938-pascal-person-part.pth --gpu=None --input-dir=.\data --output-dir=.\outputs
```
